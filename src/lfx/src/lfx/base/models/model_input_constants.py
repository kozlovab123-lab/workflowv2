...
def _get_gigachat_inputs_and_fields():
    try:
        from lfx.components.sber.gigachat import GigaChatModelComponent

        gigachat_inputs = get_filtered_inputs(GigaChatModelComponent, provider_name="SBER")
    except ImportError as e:
