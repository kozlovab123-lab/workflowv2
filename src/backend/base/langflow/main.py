...
def get_lifespan(*, fix_migration=False, version=None):
    ...
    async def lifespan(_app: FastAPI):
        ...
        try:
        ...
        except UnsupportedPostgreSQLVersionError as exc:
            ...
            # Use sys.exit so frozen/uvicorn callers surface the message (os._exit skips handlers).
            sys.exit(3)
        except Exception as exc:
            ...
            log_level = os.getenv("LANGFLOW_LOG_LEVEL", "error").lower()
